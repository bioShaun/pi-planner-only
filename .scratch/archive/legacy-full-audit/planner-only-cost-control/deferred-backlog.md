...
| 3 | 设计文档 §9 三条：status 的 role-model 措辞加限定、无条件打印真实 root 模型 | 否 | **p18-r084 已收**（`574aa07`） |
| 4 | 工单 19 真实费用对照实验 | **是** | 冻结见 `p19-experiment/freeze.md`：样本只 38/39 两 arm，未点名 +1–2 不加。p18-r085 只写驱动+离线闸门，不开付费组。 |
